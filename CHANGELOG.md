...
### Changed
- Sort data in generated `i18n-map.php` file to avoid spurious diffs.
...
[1.1.5-alpha]: https://github.com/Automattic/jetpack-composer-plugin/compare/v1.1.4...v1.1.5-alpha
